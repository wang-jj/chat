...
public class RegistrationActivity extends BaseActivity<RegistrationActivity,LoginPresenter<RegistrationActivity>> {
    ...
    public void creatSelect(){
        PictureSelector.create(RegistrationActivity.this).openGallery(PictureMimeType.ofImage()).theme(R.style.picture_white_style).enableCrop(true).previewImage(true).compress(true).minimumCompressSize(200).isGif(false).maxSelectNum(1).isDragFrame(true).rotateEnabled(true).hideBottomControls(false).forResult(PictureConfig.CHOOSE_REQUEST);
    }
